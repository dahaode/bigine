...
bigine.core.tag.factory.$map = {
    ...
    '剧情结束': 'bigine.action.episode.finish',
    '剧情完结': 'bigine.action.episode.finish',
    '剧情失败': 'bigine.action.episode.over',
...
bigine.core.tag.factory.__BROWSERIFY_HACK__ = function() {
    ...
    require('bigine/action/episode/finish');
    require('bigine/action/episode/over');
