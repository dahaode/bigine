...
bigine.core.tag.factory.__BROWSERIFY_HACK__ = function() {
    ...
    require('lib/action/value/assign');
    require('lib/action/value/choose');
    require('lib/action/sequence/otherwise');
    require('lib/action/sequence/when');
    require('lib/action/room/bgm');
    require('lib/action/room/cgoff');
    require('lib/action/room/cgon');
    require('lib/action/room/fake');
