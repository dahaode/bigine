...
bigine.bigine.__BROWSERIFY_HACK__ = function() {
    ...
    require('bigine/object/char');
    require('bigine/object/char/avatar');
    require('bigine/object/char/pose');
    require('bigine/object/room');
    require('bigine/object/room/snap');
    require('bigine/object/weather');
    require('bigine/object/weather/effect');
    ...
    require('bigine/action/char/place');
...
bigine.bigine.$tags = [
    ...
    'bigine.object.weather.effect',
    'bigine.object.bgm',
    'bigine.object.common.audio',
    'bigine.object.char',
    'bigine.object.char.avatar',
    'bigine.object.char.pose'
];

bigine.bigine.$prototypes = {
    '音乐': 'bigine.object.bgm',
    '音源': 'bigine.object.common.audio',
    '人物': 'bigine.object.char',
    '头像': 'bigine.object.char.avatar',
    '姿态': 'bigine.object.char.pose',
    '房间': 'bigine.object.room',
    '时刻': 'bigine.object.room.snap',
    '天气': 'bigine.object.weather',
    '动画': 'bigine.object.weather.effect',
