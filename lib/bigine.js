...
$.run = function(tags, level, director) {
    ...
    return (new bigine.runtime.runtime(root, level)).setup();
};
...
$.browserify = function() {
    ...
    require('./runtime/env');
    require('./runtime/resource');
    require('./runtime/director');
    require('./runtime/director/canvas');
    require('./runtime/director/canvas/stage');
