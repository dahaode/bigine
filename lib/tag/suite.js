...
bigine.tag.suite.prototype.$fill = function(episode) {
    ...
    return bigine.util.resource.getSuite(this.entities).then(function (data) {
        ...
        try {
            ...
            bigine.util.each(data.chars || {}, $.$char, episode);
            bigine.util.each(data.cgs || {}, $.$cg, episode);
            bigine.util.each(data.maps || {}, $.$mapt, episode);
            bigine.util.each(data.bgms || {}, $.$bgm, episode);
            bigine.util.each(data.ses || {}, $.$se, episode);
        } catch (error) {
 ...
 * @static
 */
bigine.tag.suite.$room = function(item, index) {
 ...
 * @static
 */
bigine.tag.suite.$room.$snap = function(item, index) {
 ...
 * @static
 */
bigine.tag.suite.$char = function(item, index) {
    ...
    if (item.poses) {
        ...
        xpc.$append(poses);
        bigine.util.each(item.poses, $.$char.$pose, poses);
    }
    xpc.$register(this);
};
 ...
 * @static
 */
bigine.tag.suite.$char.$pose = function(item, index) {
 ...
 * @static
 */
bigine.tag.suite.$cg = function(item, index) {
 ...
 * @static
 */
bigine.tag.suite.$mapt = function(item, index) {
 ...
 * @static
 */
bigine.tag.suite.$mapt.$point = function(item, index) {
 ...
 * @static
 */
bigine.tag.suite.$bgm = function(item, index) {
    var bgm = new bigine.entity.bgm(0, [], item.title);
    bgm.$append(new bigine.entity.common.audio(0, [], item.audio));
    bgm.$register(this);
};
 ...
 * @static
 */
bigine.tag.suite.$se = function(item, index) {
    var se = new bigine.entity.se(0, [], item.title);
    se.$append(new bigine.entity.common.audio(0, [], item.audio));
    se.$register(this);
};
