 ...
 * @return {bigine.tag.event.type}
 * @constructs
 */
bigine.tag.event.type = function(line, params, content) {
    bigine.core.tag.call(this, line, params, content);
    this.$id = 'bigine.tag.event.type';
    var grammar = /^([^（]+)(?:|（(\S+)）)$/,
...
bigine.tag.event.type.prototype = new bigine.core.tag();

module.exports = bigine.tag.event.type;
