...
bigine.tag.scene.prototype.perform = function(context) {
    switch (true) {
        ...
        case bigine.core.emittable.TYPE_ROOM_BEFORE_ENTER == this.type.id && this.type.reference != context.state['$n']:
        case bigine.core.emittable.TYPE_ROOM_AFTER_ENTER == this.type.id && this.type.reference != context.state['$r']:
        case bigine.core.emittable.TYPE_ROOM_BEFORE_LEAVE == this.type.id && this.type.reference != context.state['$r']:
        case bigine.core.emittable.TYPE_ROOM_AFTER_LEAVE == this.type.id && this.type.reference != context.state['$r']:
    ...
    if (bigine.core.emittable.TYPE_ROOM_BEFORE_LEAVE == this.type.id ||
        ...
        promise = context.director.setRoom(this.type.reference);
    }
    return promise.then(function () {
        self.plot.play(context);
    });
};
