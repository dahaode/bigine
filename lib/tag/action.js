...
/** @inheritDoc */
bigine.tag.action.prototype.toScript = function() {
    var clob = bigine.core.tag.prototype.toScript.call(this);
    if (this.id) {
...
bigine.tag.action.prototype.act = function(context) {
    ...
    throw new bigine.error('动作“' + this.$prototype + '”逻辑未实现', this.$line);
};
