...
var bigine = require('../bigine').$namespace('.runtime.env')
    .$import('.util'),
    $ = bigine.runtime.env;
 ...
 * @type {Window}
 */
bigine.runtime.env.window = 'undefined' == typeof window ? false : window;
 ...
 * @type {Object}
 */
bigine.runtime.env.browser = (function () {
    var ua = bigine.runtime.env.window ? bigine.runtime.env.window.navigator.userAgent.toLowerCase() : false,
        $ = function(regex) {
            if (!ua) return '';
    ...
    if (tablet || 'ipad' == ios || (android && (3 == osver0 || (4 == osver0 && !mobile))) || result.silk) {
        result.tablet = true;
    } else if (mobile || 'ipod' == ios || 'iphone' == ios || android || result.blackberry || result.webos || result.bada) {
        result.mobile = true;
    }
    return result;
})();
 ...
 * @type {Object}
 */
bigine.runtime.env.screen = (function () {
    if (!$.window) return {
        width: 1920,
        height: 1080
    };
 ...
 * @type {Boolean}
 */
bigine.runtime.env.mobile = $.browser.tablet || $.browser.mobile;
 ...
 * @type {Boolean}
 */
bigine.runtime.env.canvas = (function () {
    if (!$.window) return false;
    if ($.browser.msie) return 9 < parseFloat($.browser.version);
 ...
 * @type {String}
 */
bigine.runtime.env.protocol = $.window && 'https:' == $.window.location.protocol ? 'https:' : 'http:';
