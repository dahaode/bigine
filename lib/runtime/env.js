...
var bigine = require('../bigine').$namespace('.runtime')
    .$import('.util'),
    ua = bigine.util.isDefined(navigator) ? navigator.userAgent.toLowerCase() : false;
...
bigine.runtime.env.screen.width = bigine.util.isDefined(screen) && screen.width || 1920;
