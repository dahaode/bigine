...
bigine.runtime.runtime = bigine.$extends(bigine.core.component, function (tags, level) {
     ...
     * 资源加载器实例。
     *
     * @type {bigine.runtime.resource}
     */
    this.resource = new bigine.runtime.resource();
        ...
        Object.defineProperties(this, {
            volume: {
                ...
                set: function(value) {
                    ...
                    if (0 > value) value = 0;
                    else if (1 < value || isNaN(value)) value = 1;
                    self.$volume = value;
                    if (self.director && self.director.bgm) {
                        self.director.bgm.volume = value;
                        self.director.se.volume = value;
                    }
                }
            },
            auto: {
                ...
                set: function(value) {
                    self.$auto = !!value;
                    if (self.director) self.director.click();
                }
            }
        });
    }
 ...
 * @return {bigine.runtime.runtime}
 */
bigine.runtime.runtime.prototype.setup = function() {
    var self = this;
    ...
    this.addEventListener('continue', function () {
        self.state.load().fail(function (error) {
            ...
            self.logger.info('    [load]', error.message || error.reason);
            return bigine.util.promise.reject(error);
        }).then(function () {
            self.episode.resume(self).fail(function (error) {
                if (-1 != error.$signal) self.logger.error(error);
            });
        });
    });
    ...
    this.director = bigine.runtime.director.factory();
 ...
 * @return {bigine.runtime.runtime}
 */
bigine.runtime.runtime.prototype.replay = function() {
    if (this.$playing) return this;
    ...
    this.dispatch(new bigine.runtime.event.ready());
    return this.play(save, load);
};
 ...
 * @return {Boolean}
 */
bigine.runtime.runtime.muted = function() {
    return !!this.$volume;
};
