...
bigine.runtime.director.classic.prototype.init = function(runtime) {
    ...
    if (els.length) {
        ...
        autoplay = true;
        body.appendChild(el);
        el.className = 'bg-work fullscreen';
    }
    this.fix();
    bigine.util.once(runtime, 'ready', function () {
...
bigine.runtime.director.classic.prototype.$logo$render = function() {
    ...
    this.viewport.$logo.innerHTML = '<img src="http://s.dahao.de/lib/bigine/logo.png">';
};
...
bigine.runtime.director.classic.prototype.$curtain$show = function() {
    ...
    this.curtain = true;
    if (this.viewport.$se) {
        this.viewport.$se.src = 'http://s.dahao.de/lib/bigine/oops.mp3';
    }
    var self = this;
    return $.$fade$in(this.viewport.$curtain, 30);
};
...
bigine.runtime.director.classic.$fade$in = function(element, frames) {
    return promise.animate(function (counter) {
        if (1 == counter) {
            $.$show(element);
        }
...
bigine.runtime.director.classic.prototype.$type = function(words, container) {
    ...
    h = false;
    jj = promise.animate(function (index, times) {
        if (index == times) {
            index++;
        }
...
bigine.runtime.director.classic.prototype.$curtain$hide = function() {
    ...
    var self = this;
    return $.$fade$out(this.viewport.$curtain, 30);
};
...
bigine.runtime.director.classic.prototype.$chars$animate$middle = function(pose) {
    ...
    this.viewport.$chars.$middle.style.top = '20%';
    return $.$fade$in(this.viewport.$chars.$middle, 12);
};
...
bigine.runtime.director.classic.prototype.$chars$animate$left = function(pose) {
    ...
    var self = this;
    return promise.all([
        $.$fade$in(this.viewport.$chars.$left, 12),
        $.$move(this.viewport.$chars.$left, this.width * 0.025, 12)
    ]);
};
...
bigine.runtime.director.classic.prototype.$chars$animate$right = function(pose) {
    ...
    return promise.all([
        $.$fade$in(this.viewport.$chars.$right, 12),
        $.$move(this.viewport.$chars.$right, - this.width * 0.025, 12)
    ]);
};
...
bigine.runtime.director.classic.prototype.$cg$show = function(image) {
    ...
    return promise.all([
        $.$fade$in(this.viewport.$cg, 30),
        $.$shrink(this.viewport.$cg, 12)
...
bigine.runtime.director.classic.prototype.$cg$hide = function() {
    ...
    return $.$fade$out(this.viewport.$cg, 12).then(function () {
...
bigine.runtime.director.classic.prototype.$chars$hide$left = function() {
    ...
    return promise.all([
        $.$fade$out(this.viewport.$chars.$left, 12),
        $.$move(this.viewport.$chars.$left, - this.width * 0.025, 12)
    ]).then(function () {
...
bigine.runtime.director.classic.prototype.$chars$hide$middle = function() {
    ...
    return promise.all([
        $.$fade$out(this.viewport.$chars.$middle, 12),
        $.$climb(this.viewport.$chars.$middle, this.height * 0.075, 12)
    ]).then(function () {
...
bigine.runtime.director.classic.prototype.$chars$hide$right = function() {
    ...
    return promise.all([
        $.$fade$out(this.viewport.$chars.$right, 12),
        $.$move(this.viewport.$chars.$right, this.width * 0.025, 12)
    ]).then(function () {
...
bigine.runtime.director.classic.$audio = function(options) {
    ...
    audio.src = 'http://s.dahao.de/lib/bigine/oops.mp3';
    return audio;
};
...
bigine.runtime.director.classic.prototype.destroy = function() {
    ...
    this.viewport = undefined;
    window.document.body.querySelectorAll('.bg-work')[0].innerHTML = '';
};
