...
$.layers = function(doc) {
    var div = function(className, child) {
        ...
        els = doc.getElementsByTagName('bg-viewport');
...
bigine.runtime.director.classic.prototype.play = function(episode, context) {
    var self = this,
        begin = function() {
            ...
            episode.begin(context).fail(function (error) {
    ...
    if (episode.autostart()) {
        ...
        bigine.util.on('click', $.viewport.start, begin).style.display = 'block';
    }
