...
bigine.runtime.director.classic.prototype.init = function(runtime) {
    ...
    width = parseInt(this.viewport.$_player.$_viewport.scrollWidth, 10);
    height = parseInt(this.viewport.$_player.$_viewport.scrollHeight, 10);
    size = height / 9 * 16;
    if (size > width) {
        size = width / 16 * 9;
        this.zoom = size / 720;
    ...
    runtime.logger.info('[director]', width, 'x', height, '(', (this.zoom * 100), '%)');
...
bigine.runtime.director.classic.prototype.$style = function(element, changeset) {
    ...
    bigine.util.each(changeset, this.$style.$apply, context);
    return element;
};
 ...
 * @return {void}
 */
bigine.runtime.director.classic.prototype.$style.$apply = function(value, key) {
    var self = this;
    switch (key) {
        case 'top':
        case 'left':
...
bigine.runtime.director.classic.prototype.$map$show = function(map) {
    ...
    bigine.util.each(map.points, this.$map$show$point, this);
 ...
 * @return {void}
 */
bigine.runtime.director.classic.prototype.$map$show$point = function(point, index) {
    if ('length' == index) {
        return;
    }
    var self = this,
...
bigine.runtime.director.classic.prototype.voiceover = function(metas, context) {
    ...
    return promise.all([
        ...
        self.viewport.$voiceover.style.zIndex = -1;
        return context;
    });
};
...
bigine.runtime.director.classic.prototype.$speak$render = function() {
    ...
    var self = this;
    bigine.util.each(this.runtime.episode.theme.speak, function (changeset, className) {
        var el = self.viewport.$speak.appendChild(self.$style($.$div(className), changeset));
        switch (className) {
            case 'text':
                self.viewport.$speak.$text = el;
                break;
            case 'name':
                self.viewport.$speak.$name = el;
                break;
            case 'avatar':
                self.viewport.$speak.$avatar = el;
                break;
        }
    });
};
...
bigine.runtime.director.classic.prototype.$monolog$render = function() {
    ...
    var self = this;
    bigine.util.each(this.runtime.episode.theme.monolog, function (changeset, className) {
        var el = self.viewport.$monolog.appendChild(self.$style($.$div(className), changeset));
        switch (className) {
            case 'text':
                self.viewport.$monolog.$text = el;
                break;
            case 'name':
                self.viewport.$monolog.$name = el;
                break;
            case 'avatar':
                self.viewport.$monolog.$avatar = el;
                break;
        }
    });
};
...
bigine.runtime.director.classic.prototype.$voiceover$show = function(words) {
    ...
    this.viewport.$voiceover.$text.innerHTML = words;
    this.viewport.$voiceover.style.zIndex = 99;
...
bigine.runtime.director.classic.prototype.$voiceover$render = function() {
    ...
    var self = this;
    bigine.util.each(this.runtime.episode.theme.voiceover, function (changeset, className) {
        var el = self.viewport.$voiceover.appendChild(self.$style($.$div(className), changeset));
        if ('text' == className) {
            self.viewport.$voiceover.$text = el;
        }
    });
};
...
bigine.runtime.director.classic.prototype.speak = function(metas, context) {
    ...
    return promise.all([
        ...
        self.viewport.$speak.style.zIndex = -1;
        return context;
    });
};
...
bigine.runtime.director.classic.prototype.$speak$show = function(name, avatar, words) {
    ...
    this.viewport.$speak.$text.innerHTML = words;
    $.$show(this.viewport.$speak);
    this.viewport.$speak.style.zIndex = 99;
    return this.oops();
};
...
bigine.runtime.director.classic.prototype.monolog = function(metas, context) {
    ...
    return promise.all([
        ...
        self.viewport.$monolog.style.zIndex = -1;
        return context;
    });
};
...
bigine.runtime.director.classic.prototype.$monolog$show = function(name, avatar, words) {
    ...
    this.viewport.$monolog.$text.innerHTML = words;
    this.viewport.$monolog.style.zIndex = 99;
...
bigine.runtime.director.classic.prototype.$tip$show = function(words) {
    ...
    this.viewport.$tip.$text.innerHTML = words;
...
bigine.runtime.director.classic.prototype.$tip$render = function() {
    ...
    bigine.util.each(this.runtime.episode.theme.tip, function (changeset, className) {
        var el = self.viewport.$tip.appendChild(self.$style($.$div(className), changeset));
        if ('text' == className) {
            self.viewport.$tip.$text = el;
        }
    });
};
