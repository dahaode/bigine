...
bigine.runtime.director.classic.prototype.$type = function(words, container) {
    ...
    jj = promise.race([
        jj,
        promise.click(this.viewport, [13, 32]).then(function () {
            h = true;
            container.innerHTML = words;
        })
    ]);
    return jj.click(this.viewport, [13, 32]);
};
...
bigine.runtime.director.classic.prototype.$tip$show = function(words) {
    ...
    return promise.click(this.viewport, [13, 32]);
};
...
bigine.runtime.director.classic.prototype.$choose$show = function(options) {
    ...
    return new promise(function (resolve) {
        ...
        $.$style(self.viewport.$choose.$options, {
            top: - self.height + 'px',
            left: - self.width + 'px',
            width: self.runtime.episode.theme.choose.width + 'px'
        });
...
bigine.runtime.director.classic.prototype.end = function(context) {
    ...
    return this.rest(context).delay(500).then(function () {
        ...
        bigine.each(self.viewport.$se, function (audio) {
            audio.pause();
        });
...
/** @inheritDoc */
bigine.runtime.director.classic.prototype.destory = function() {
    if (this.viewport.$bgm) {
        this.viewport.$bgm.pause();
    }
    bigine.each(this.viewport.$se, function (audio) {
        audio.pause();
    });
    this.viewport = undefined;
