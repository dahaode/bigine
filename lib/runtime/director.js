...
bigine.runtime.director.prototype.play = function() {
    ...
    this.curtain$show().delay(500).then(function () {
        return self.logo$show('http://s.dahao.de/lib/bigine/logo.png');
    }).then(function () {
...
bigine.runtime.director.prototype.bgm$play = function(id) {
    ...
    if (!id) this.bgm.src = 'http://s.dahao.de/lib/bigine/oops.mp3';
    return this.oops();
};
...
bigine.runtime.director.prototype.se$play = function(id) {
    ...
    if (!id) this.se.src = 'http://s.dahao.de/lib/bigine/oops.mp3';
    else this.se.cd = 2;
    return this.oops();
};
...
bigine.runtime.director.prototype.end = function(context) {
    ...
    return this.curtain$show().delay(500).then(function () {
        return self.end$show(self.runtime.episode.theme.start.image, 'http://s.dahao.de/lib/bigine/thx.png');
    }).then(function () {
        return self.curtain$hide();
    }).delay(2000).then(function () {
        return self.curtain$show();
...
bigine.runtime.director.prototype.rank = function(metas, context) {
    var self = this,
        image = 'http://s.dahao.de/lib/bigine/1star.png';
    switch (metas.rank) {
        case '完美':
            image = 'http://s.dahao.de/lib/bigine/3stars.png';
            break;
        case '优秀':
            image = 'http://s.dahao.de/lib/bigine/2stars.png';
            break;
        default:
    }
