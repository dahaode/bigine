 ...
 * @return {bigine.util.promise}
 */
bigine.runtime.director.prototype.tip = function(context, words) {
    context.logger.error('bigine.runtime.director#tip(context,', words, ')');
    return this.oops(context);
};
 ...
 * @return {bigine.util.promise}
 */
bigine.runtime.director.prototype.rank = function(context, stars) {
    context.logger.error('bigine.runtime.director#rank(context,', stars, ')');
    return this.oops(context);
};
