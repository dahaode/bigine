...
bigine.runtime.director.prototype.init = function(runtime) {
    ...
    bigine.util.once(runtime, 'ready', function () {
        ...
        var theme = runtime.episode.theme;
        runtime.resource
            .register(theme.start.image)
            .register(theme.start['new'].image)
            .register(theme.start['new'].hover)
            .register(theme.start.load.image)
            .register(theme.start.load.hover)
            .register(theme.speak.back.image)
            .register(theme.monolog.back.image)
            .register(theme.voiceover.back.image)
            .register(theme.tip.back.image)
            .register(theme.choose.option.back.image)
            .register(theme.choose.option.back.hover);
        if (self.began) self._play();
        self.began = true;
    });
    runtime.resource
        .register('//s.dahao.de/lib/bigine/logo.png')
        .register('//s.dahao.de/lib/bigine/thx.png')
        .register('//s.dahao.de/lib/bigine/3stars.png')
        .register('//s.dahao.de/lib/bigine/2stars.png')
        .register('//s.dahao.de/lib/bigine/1star.png');
    return false;
};
...
bigine.runtime.director.prototype.play = function() {
    ...
    this.curtain$show().delay(500).then(function () {
        return self.logo$show('//s.dahao.de/lib/bigine/logo.png');
    }).then(function () {
...
bigine.runtime.director.prototype.bgm$play = function(id) {
    if (!this.bgm) {
        ...
        this.bgm.loop = true;
        this.bgm.volume = this.runtime.volume;
        this.bgm.play();
    }
...
bigine.runtime.director.prototype.se$play = function(id) {
    if (!this.se) {
        ...
        this.se.volume = this.runtime.volume;
        this.se.cd = -1;
        this.se.play();
    }
...
bigine.runtime.director.prototype.end = function(context) {
    ...
    return this.rest(context).delay(500).then(function () {
        return self.end$show(self.runtime.episode.theme.start.image, '//s.dahao.de/lib/bigine/thx.png');
    }).then(function () {
        return self.curtain$hide();
    }).delay(2000).then(function () {
        return self.curtain$show();
 ...
 * @return {bigine.util.promise}
 */
bigine.runtime.director.prototype.rank$hide = function() {
    this.runtime.logger.error('bigine.runtime.director#rank$hide()');
    return this.oops();
};
 ...
 * @return {void}
 */
bigine.runtime.director.prototype.click = function() {
    this.runtime.logger.error('bigine.runtime.director#click()');
};
