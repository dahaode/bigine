...
bigine.runtime.state.prototype.save = function(title, completed) {
    ...
    return new bigine.util.promise(function (resolve, reject) {
        ...
        self.onSave(title, data, !!completed, function (data) {
            resolve(data);
        }, function (error) {
            reject(error);
        });
 ...
 * @return {void}
 */
bigine.runtime.state.prototype.onSave = bigine.util.noop;
...
bigine.runtime.state.prototype.load = function(completed) {
    var self = this;
    return new bigine.util.promise(function (resolve, reject) {
        self.onLoad(!!completed, function (data) {
            console.log(data);
 ...
 * @return {void}
 */
bigine.runtime.state.prototype.onLoad = bigine.util.noop;
