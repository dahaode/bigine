 ...
 * @return {Boolean}
 */
bigine.util.isObject = function(puzzle) {
    return 'object' == typeof puzzle || puzzle instanceof Object;
};
 ...
 * @return {HTMLElement}
 */
bigine.util.off = function(element, event, handler) {
    if (!handler) {
        this.each(event, function (handler, event) {
            bigine.util.off(element, event, handler);
        });
        return element;
    }
