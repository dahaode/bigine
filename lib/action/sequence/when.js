 ...
 */
bigine.action.sequence.when = bigine.core.component.$extends(bigine.tag.action, function(line, params, content) {
...
/** @inheritDoc */
bigine.action.sequence.when.prototype.$expectParams = function() {
    return [1, 1];
};

/** @inheritDoc */
bigine.action.sequence.when.prototype.$expectChildren = function() {
    return {
        '*': true
    };
};
...
/** @inheritDoc */
bigine.action.sequence.when.prototype.act = function(context) {
