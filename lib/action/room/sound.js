...
bigine.action.room.sound.prototype.act = function(context) {
    context.logger.info(' [episode] 播放音效【', this.se.title, '】');
    return context.director.playSE(this, context);
};

/** @inheritDoc */
bigine.action.room.sound.prototype.$prefetch = function(resource) {
    resource.register(this.se.audio.src, 'se');
};
