 ...
 * @constructs
 */
bigine.action.room.weather = function(line, params, content) {
    bigine.tag.action.call(this, line, params, content);
    this.$prototype = 'bigine.action.room.weather';
    this.weather = this.$params[0];
};
bigine.action.room.weather.prototype = new bigine.tag.action();
 ...
 * @return {bigine.action.room.weather}
 */
bigine.action.room.weather.prototype.bind = function(runtime) {
    this.weather = runtime.getWeather(this.weather);
