...
bigine.action.character.pose.prototype.act = function(context) {
    if (!this.character.position) {
        return bigine.util.promise.reject(new bigine.error('人物“' + this.character.title + '”不在场', this));
    }
...
/** @inheritDoc */
bigine.action.character.pose.prototype.$prefetch = function(resource) {
    resource.register(this.character.poses[this.pose] || this.character.poses[''], 'pose');
};
