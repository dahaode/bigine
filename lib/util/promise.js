 ...
 * @return {bigine.util.promise}
 */
bigine.util.promise.prototype.key = function(element, code) {
    return this.then(function () {
...
bigine.util.promise.key = function(code) {
    return new $(function (resolve) {
        bigine.util.on(window.document.body, 'keypress', function (event) {
        });
    });
};
 ...
 * @return {bigine.util.promise}
 */
bigine.util.promise.prototype.click = function(element) {
    return this.then(function () {
 ...
 * @static
 */
bigine.util.promise.click = function(element) {
    if (!element) {
        return $.resolve();
    }
    return new $(function (resolve) {
