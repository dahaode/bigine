...
bigine.util.resource.getSuite = function(uuid) {
    return new bigine.util.promise(function (resolve, reject) {
        $.$xhr('POST', bigine.runtime.env.protocol + '//api.dahao.de/resource/' + uuid + '/?' + bigine.$version, resolve, reject);
    });
};
...
bigine.util.resource.getTheme = function(uuid) {
    return new bigine.util.promise(function (resolve, reject) {
        $.$xhr('GET', $.$url(uuid) + 'theme.json?' + bigine.$version, resolve, reject);
    });
};
...
bigine.util.resource.$url = function(id) {
    return bigine.runtime.env.protocol + '//s.dahao.de/theme/' + id + '/';
};
